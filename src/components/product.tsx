import { CpuFlowBackground } from "./ui/circuit_flow";
        ...
        <section className="relative w-full min-h-screen py-20 bg-black flex flex-col items-center overflow-hidden">
            ...
            <div className="relative z-10 w-11/12 max-w-7xl">
                ...
                <p className="text-lg text-white/80 mb-12 text-center max-w-3xl mx-auto">
                    Experience the future of technology with our cutting-edge product designed to revolutionize your workflow and enhance productivity.
                </p>
