...
const Footer: React.FC = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden font-sans">
      ...
      <div className="absolute bottom-[-10%] left-1/2 -translate-x-1/2 select-none pointer-events-none z-0">
      ...
      <div className="relative z-10 w-full max-w-[1200px] bg-black shadow-white rounded-[2.5rem] shadow-xl p-8 md:p-12 lg:p-16">
          ...
          <div className="flex flex-col max-w-sm">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div className="flex items-center gap-3">
                <span className="text-xl font-bold text-white tracking-tight">Kafei</span>
              </div>
            </div>

            <p className="text-gray-500 text-[15px] leading-relaxed mb-8">
            cbwc;eowic;oewibce ceoceive o coewio;cwe cce  gweiudwdwo;dw dfgeiufeidowdg qw d dw g dwdgi wdwgdiqwd dgw dwd wd
            </p>
            ...
            <div className="flex items-center gap-5 text-white">
              ...
              <a href="#" className="hover:text-gray-600 transition-colors">
                <Linkedin size={20} strokeWidth={2.2} fill="currentColor" className="stroke-none" />
              </a>
              <a href="#" className="hover:text-gray-600 transition-colors">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3.5">
                {footerLinks.product.map((link) => (
                  <li key={link.label}>
                    <a href={link.href} className="text-gray-500 hover:text-gray-900 text-[15px] transition-colors">
                      {link.label}
                    </a>
                  </li>
                ))}
        ...
        <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-6 text-sm text-gray-500">
          ...
          <div className="flex items-center gap-8">
            <a href="#" className="hover:text-gray-900 hover:underline underline-offset-4 transition-all">Privacy Policy</a>
            <a href="#" className="hover:text-gray-900 hover:underline underline-offset-4 transition-all">Terms of Service</a>
            <a href="#" className="hover:text-gray-900 hover:underline underline-offset-4 transition-all">Cookies Settings</a>
          </div>
        </div>
      </div>
    </div>
